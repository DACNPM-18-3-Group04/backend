...
const getMailOAuthClientSecret = () => {
  return process.env.MAIL_OAUTH_CLIENT_SECRET || DEFAULT_MAIL_OAUTH_CLIENT_SECRET;
}

const getMailOAuthRefreshToken = () => {
  return process.env.MAIL_OAUTH_REFRESH_TOKEN || DEFAULT_MAIL_OAUTH_REFRESH_TOKEN;
}
